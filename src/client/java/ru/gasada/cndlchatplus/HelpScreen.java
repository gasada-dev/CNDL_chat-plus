...
public final class HelpScreen extends CompatScreen {
	private static final List<Page> PAGES = List.of(
			new Page("Управление и чат", List.of(
					...
					"Экран не ставит сетевую игру на паузу.",
			...
			new Page("Каналы и фильтры", List.of(
					...
					"Чат Discord можно скрыть полностью.",
			...
			new Page("Друзья и игроки", List.of(
					...
					"HUD показывает друзей онлайн и уведомляет об их появлении.",
			...
			new Page("Телепорт и Alt+ПКМ", List.of(
					"Входящий запрос ТП показывает HUD-кнопку на 60 секунд и звук.",
