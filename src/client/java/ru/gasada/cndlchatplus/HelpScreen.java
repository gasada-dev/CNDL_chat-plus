...
public final class HelpScreen extends CompatScreen {
	private static final List<Page> PAGES = List.of(
			...
			new Page("Каналы и фильтры", List.of(
					"Маркеры локального, глобального, кланового, личного и Discord-чата берутся из конфигурации Vanilla-box.",
			...
			new Page("Vanilla-box и обновления", List.of(
					"Мод использует фиксированную конфигурацию Vanilla-box.",
					"Друзья, фильтры и команды хранятся внутри этой конфигурации.",
